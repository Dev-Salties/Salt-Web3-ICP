...
export default function Shop() {
  ...
  return (
    <>
    {selectedProduct && (
      <EnquiryModal product={selectedProduct} onClose={() => setSelectedProduct(null)} />
    )}
    <motion.div
      variants={pageFade}
      initial="initial"
    ...
    >
      <Helmet>
        ...
        <meta name="description" content="Browse Microsoft 365, Azure, security, and backup software solutions available from Salt Essential IT." />
      </Helmet>
      <PageHero
        title="Salt Shop"
